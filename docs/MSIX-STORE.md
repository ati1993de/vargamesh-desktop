...
VargaMesh Desktop v0.3.1 is prepared so the normal Windows x64 installer can be converted with Microsoft's **MSIX Packaging Tool**.
...
3. Select `VargaMesh-Desktop-v0.3.1-Windows-x64-Setup.exe`.
